...
@WebServlet(urlPatterns="/KaoQinQuery")
public class KaoQinQueryServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			List<LeJia> kaoQinList = LeJiaService.getKaoQin();
			request.setAttribute("KaoQin",kaoQinList);
